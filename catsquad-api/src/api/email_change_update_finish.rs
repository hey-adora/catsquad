...
// mod test_utils {
//     use catsquad_shared::{
//         EmailChangeRes, EmailChangeUpdateFinishErr, EmailChangeUpdateFinishReq,
//         LINK_API_EMAIL_CHANGE_UPDATE_FINISH, ToForm,
//     };
...
//         ) -> Result<EmailChangeRes, EmailChangeUpdateFinishErr> {
//             let session_key = session_key.into();
//             let data: String = EmailChangeUpdateFinishReq {
//                 email_change_key: email_change_key.into(),
//             }
//             .to_form()
//             .unwrap();

//             self.post_auth(LINK_API_EMAIL_CHANGE_UPDATE_FINISH, data, session_key)
//                 .await
//                 .0
//         }
//     }
...
//         let result = server
//             .email_change_update_finish("invalid", &session_key)
//             .await;
//         assert!(matches!(result, Err(EmailChangeUpdateFinishErr::NotFound)));

//         let result = server
//             .email_change_update_finish(email_change.key.clone(), &session_key2)
//             .await;
//         assert!(matches!(
//             result,
...
//         let (user4, session_key4) = server
//             .user_add_2("hey4", "hey4@heyadora.com", "1234567890111GG11$")
//             .await;
